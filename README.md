...
| June 30 | [Approximate Bayesian Inference for Latent Gaussian Models Using Integrated Nested Laplace Approximations] (http://onlinelibrary.wiley.com/doi/10.1111/j.1467-9868.2008.00700.x/abstract) | Rayne | Outlines the general method of using INLA to approximate posterior marginals that do not have a closed form.
| June 30 | [Tractable Nonparametric Bayesian Inference in Poisson Processes
with Gaussian Process Intensities] (http://dl.acm.org/citation.cfm?id=1553376) | Rayne | Developes a method for estimating the posterior distribution of the intesity function of an inhomogenous Poisson process using a Gaussian Cox prior and a thinning algorithm to simulate the Poisson process without specification of the intesity. 
