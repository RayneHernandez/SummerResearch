...
| TBD |[nextflu: real-time tracking of seasonal influenza virus evolution in humans](https://academic.oup.com/bioinformatics/article-lookup/doi/10.1093/bioinformatics/btv381) | Rayne | Overview of the NextFlu project outlining the data processing pipeline used to load and clean influenza and build a phylogentic tree from sequence data |
| TBD |[Gaussian Process-Based Bayesian Nonparametric Inference of Population Size Trajectories from Gene Genealogies](http://onlinelibrary.wiley.com/doi/10.1111/biom.12003/full) | Rayne | Given a geneology, the paper proposes Bayesian nonparametric estimation of its effective population size trajectory. |
| TBD | [Integrated Nested Laplace Approximation for Bayesian Nonparametric Phylodynamics](https://arxiv.org/abs/1210.4908) | Rayne | Improves upon the previous method of estimating the effective population size trajectory by sampling the posterior distribution of the population size trajectory using an INLA instead of a MCMC. This improves both accuracy and computational efficiency of the previous method|
